...
void main() {
  ...
  testWidgets('Tests some plain old text', (WidgetTester tester) async {
    await tester.pumpWidget(
      MaterialApp(
        home: Scaffold(body: Html(data: "This is some plain text")),
      ),
    );
  ...
  testWidgets('Tests that a <b> element gets rendered correctly', (
    ...
    await tester.pumpWidget(
      MaterialApp(
        home: Scaffold(body: Html(data: "<b>Bold Text</b>")),
      ),
    );
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      await tester.pumpWidget(
        MaterialApp(
          home: Scaffold(body: Html(data: "<b>Bold Text</b> and plain text")),
        ),
      );
